...
namespace ProductivityWallpaper.ViewModels
{
    ...
    /// Manages media items, playback settings, and file operations for shutdown events.
    /// </summary>
    public partial class ShutdownViewModel : ObservableObject
    {
        ...
        /// </summary>
        [ObservableProperty]
        private string _schemeName = "Shutdown";
        ...
        /// </summary>
        public string StorageKeyPrefix => "Shutdown";
        ...
        /// <summary>
        /// Activates this scheme as the current shutdown scheme.
        /// </summary>
        [RelayCommand]
