...
namespace ProductivityWallpaper.ViewModels
{
    ...
    /// Manages media items, playback settings, and file operations.
    /// </summary>
    public partial class DesktopBackgroundViewModel : ObservableObject
    {
        // --- Constants ---
        ...
        /// </summary>
        [ObservableProperty]
        private string _schemeName = "Desktop Background";
        ...
        /// <summary>
        /// Activates this scheme as the current desktop background.
        /// </summary>
        [RelayCommand]
