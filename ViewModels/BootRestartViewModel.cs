...
namespace ProductivityWallpaper.ViewModels
{
    ...
    /// Manages media items, playback settings, and file operations for boot and restart events.
    /// </summary>
    public partial class BootRestartViewModel : ObservableObject
    {
        // --- Constants ---
        ...
        /// </summary>
        [ObservableProperty]
        private string _schemeName = "Boot & Restart";
        ...
        /// </summary>
        public string StorageKeyPrefix => "BootRestart";
        ...
        /// <summary>
        /// Activates this scheme as the current boot/restart scheme.
        /// </summary>
        [RelayCommand]
