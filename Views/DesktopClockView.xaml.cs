...
{
    /// <summary>
    /// Interaction logic for DesktopClockView.xaml
    /// </summary>
    public partial class DesktopClockView : System.Windows.Controls.UserControl
    {
        public DesktopClockView()
        {
            InitializeComponent();
        }
        ...
        {
            if (sender is System.Windows.Controls.Border border && border.DataContext is ClockStyleModel clock)
            {
                var viewModel = DataContext as ViewModels.DesktopClockViewModel;
                viewModel?.ToggleClockActivationCommand.Execute(clock);
            }
        }
        ...
        {
            if (sender is System.Windows.Controls.Primitives.ToggleButton toggleButton && toggleButton.Tag is ClockStyleModel clock)
            {
